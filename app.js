...
const APIController = (function() {
    ...
    const clientSecret = '254548fc2eac4b92927b49451ba44ac0';
    ...
    const _getSongName = async (token, songName) => {
    ...
    const _getSearchArtist = async (token, artistName) => {
        //console.log({artistName});
    ...
    const _getTopTracksByArtist = async (token, id) => {
        //console.log({id});
    ...
    const _getTopAlbumsByArtist = async (token, id) => {
        //console.log({id});
    ...
    return {
        ...
        getSearchArtist(token, artistName) {
            return _getSearchArtist(token, artistName);
        },
        getTopTracksByArtist(token, id) {
            return _getTopTracksByArtist(token, id);
        },
        getTopAlbumsByArtist(token, id) {
            return _getTopAlbumsByArtist(token, id);
        },
        getSongName(token, songName) {
            return _getSongName(token, songName);
        }
    }
})();
...
const UIController = (function() {
    ...
    return {
        ...
        createTrackDetail(img, album, releaseDate, title, artist) {
            ...
            <div class="row col-sm-12 px-0">
                <label for="Album" class="form-label col-sm-12">Album Name: ${album}</label>
            </div>
            <div class="row col-sm-12 px-0">
                <label for="releaseDate" class="form-label col-sm-12">Release Date: ${releaseDate}</label>
            </div>
            <div class="row col-sm-12 px-0">
                <label for="Genre" class="form-label col-sm-12">Song Title: ${title}</label>
            </div>
            <div class="row col-sm-12 px-0">
                <label for="artist" class="form-label col-sm-12">Artist Name: ${artist}</label>
            </div> 
            `;
...
const APPController = (function(UICtrl, APICtrl) {
    ...
    DOMInputs.tracks.addEventListener('click', async (e) => {
        ...
        UICtrl.createTrackDetail(track.album.images[2].url, track.album.name, track.album.release_date, track.name, track.artists[0].name);
    });    
